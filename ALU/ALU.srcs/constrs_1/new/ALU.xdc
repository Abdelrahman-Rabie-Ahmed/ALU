...
set_property PACKAGE_PIN U3 [get_ports {Flags[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Flags[0]}]
set_property PACKAGE_PIN P3 [get_ports {Flags[1]}]					
...
set_property PACKAGE_PIN P1 [get_ports {Flags[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Flags[3]}]
set_property PACKAGE_PIN L1 [get_ports {Flags[4]}]					
